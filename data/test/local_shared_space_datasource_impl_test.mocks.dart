...
class MockSharedSpaceDocumentDatabaseManager extends _i1.Mock
  ...
  _i3.Future<_i4.WorkGroupDocument?> getData(String? id) =>
      (super.noSuchMethod(
            ...
            returnValue: _i3.Future<_i4.WorkGroupDocument?>.value(),
          )
  ...
  _i3.Future<List<_i4.WorkGroupDocument>> getListData() =>
      (super.noSuchMethod(
            ...
            returnValue: _i3.Future<List<_i4.WorkGroupDocument>>.value(
  ...
  _i3.Future<bool> insertData(
    _i4.WorkGroupDocument? newObject,
    String? localPath,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<bool> deleteSharedSpace(_i4.SharedSpaceId? sharedSpaceId) =>
      (super.noSuchMethod(
  ...
  _i3.Future<List<_i2.WorkGroupNodeCache>> getListWorkGroupCacheBySharedSpaceID(
    _i4.SharedSpaceId? sharedSpaceId,
      ...
      (super.noSuchMethod(
            Invocation.method(#getListWorkGroupCacheBySharedSpaceID, [
              sharedSpaceId,
            ]),
            returnValue: _i3.Future<List<_i2.WorkGroupNodeCache>>.value(
  ...
  _i3.Future<List<_i4.WorkGroupNode>> getAllSharedSpaceDocumentOffline(
    ...
    _i4.WorkGroupNodeId? parentNodeId,
      ...
      (super.noSuchMethod(
            Invocation.method(#getAllSharedSpaceDocumentOffline, [
              sharedSpaceId,
              parentNodeId,
            ]),
            returnValue: _i3.Future<List<_i4.WorkGroupNode>>.value(
              <_i4.WorkGroupNode>[],
            ),
          )
          as _i3.Future<List<_i4.WorkGroupNode>>);

  @override
  _i3.Future<List<_i2.SharedSpaceCache>> getListSharedSpace() =>
      (super.noSuchMethod(
            Invocation.method(#getListSharedSpace, []),
            returnValue: _i3.Future<List<_i2.SharedSpaceCache>>.value(
  ...
  _i3.Future<List<_i2.SharedSpaceCache>> getAllWorkgroupsInsideSharedSpaceNode(
    _i4.SharedSpaceId? parentId,
      ...
      (super.noSuchMethod(
            Invocation.method(#getAllWorkgroupsInsideSharedSpaceNode, [
              parentId,
            ]),
            returnValue: _i3.Future<List<_i2.SharedSpaceCache>>.value(
              <_i2.SharedSpaceCache>[],
  ...
  _i3.Future<bool> insertDrive(_i4.SharedSpaceNodeNested? drive) =>
      (super.noSuchMethod(
            Invocation.method(#insertDrive, [drive]),
            returnValue: _i3.Future<bool>.value(false),
          )
          as _i3.Future<bool>);
  ...
  _i3.Future<bool> deleteDrive(_i4.SharedSpaceId? sharedSpaceId) =>
      (super.noSuchMethod(
            Invocation.method(#deleteDrive, [sharedSpaceId]),
            returnValue: _i3.Future<bool>.value(false),
          )
          as _i3.Future<bool>);
}
